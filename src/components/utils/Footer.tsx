    ...
    <footer className="fixed bottom-0 w-full bg-white p-4">
      ...
      <div className="">
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-neutral-950 sm:text-center">
            © 2023{" "}
            <a
              href="https://github.com/ScanVerdict"
          ...
          <div className="mt-4 flex space-x-6 sm:mt-0 sm:justify-center">
            <a
              href="https://github.com/ScanVerdict"
              className="text-[#4267B2] hover:text-[#2f55a4] hover:underline"
            >
              <svg
                className="h-5 w-5"
                fill="currentColor"
            ...
            <a
              href="https://github.com/ScanVerdict"
              className="text-[#fd3f92] hover:text-[#C13584] hover:underline"
            >
              <svg
                className="h-5 w-5"
                fill="currentColor"
            ...
            <a
              href="https://github.com/ScanVerdict"
              className="text-[#00acee] hover:text-[#1381ab] hover:underline"
            >
              <svg
                className="h-5 w-5"
                fill="currentColor"
            ...
            <a
              href="https://github.com/ScanVerdict"
              className="text-[#3d3d3d] hover:text-[#000000]"
            >
              <svg
                className="h-5 w-5"
                fill="currentColor"
